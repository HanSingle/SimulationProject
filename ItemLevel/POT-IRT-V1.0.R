...
Scores <- apply(OBS.pot, c(1,2), sum)
round(cor(Scores),2)
...
# Model fitting
pot.o <- sem(o.model, data = obsdata, orthogonal=TRUE, fixed.x=FALSE)
pot.g <- sem(g.model, data = obsdata, orthogonal=TRUE, fixed.x=FALSE)
...
# Plotting
semPaths(pot.o, what = "std", layout = "tree2",edge.label.cex = 2.5)
semPaths(pot.g, what = "std", layout = "tree2",edge.label.cex = 2.5)
...
Scores2 <- apply(OBS.gsm, c(1,2), sum)
round(cor(Scores2),2)
obsdata2 <- as.data.frame(Scores2)

# Model fitting
gsm.o <- sem(o.model, data = obsdata2, orthogonal=TRUE, fixed.x=FALSE)
gsm.g <- sem(g.model, data = obsdata2, orthogonal=TRUE, fixed.x=FALSE)
...
# Plotting
semPaths(gsm.o, what = "std", layout = "tree2",edge.label.cex = 2.5)
semPaths(gsm.g, what = "std", layout = "tree2",edge.label.cex = 2.5)
